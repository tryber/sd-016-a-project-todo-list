...
function removeFinished() {
  const finisHim = document.querySelectorAll('li.completed');
...
function moveUp() {
  const upUp = document.querySelector('li.graycolor');
  if (upUp != null) {
...
function moveDown() {
  const downDown = document.querySelector('li.graycolor');
  if (downDown != null) {
...
function removeSelect() {
  const selectHim = document.querySelector('li.graycolor');
  if (selectHim != null) {
    selectHim.remove();
  }
}
